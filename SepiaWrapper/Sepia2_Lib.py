...
if architecture == '64bit':
    SEPIA2_LIB_DLL_NAME = "Sepia2_Lib64.dll"
else:
    SEPIA2_LIB_DLL_NAME = "Sepia2_Lib32.dll"
    

Sepia2_Lib = ct.WinDLL("C:/ProgramData/PQLaserDrv/API/Demos/Python3/" + SEPIA2_LIB_DLL_NAME)
